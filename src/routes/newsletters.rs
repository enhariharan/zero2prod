        ...
        match subscriber {
            ...
            Err(error) => {
                tracing::warn!(
                    ...
                    "Skipping a confirmed subscriber since their stored contact details are invalid",
                );
                continue;
            }
        }
...
async fn validate_credentials(
    ...
    let mut expected_password_hash= SecretString::new("$argon2id$v=19$m=15000,t=2,p=1$gZiV/M1gPc22ElAH/Jh1Hw$CWOrkoo7oJBQ/iyh7uJ0LO2aLEfrHwTWllSAxT0zRno".to_string().into());
